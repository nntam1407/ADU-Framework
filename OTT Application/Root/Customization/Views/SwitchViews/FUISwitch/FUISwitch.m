...
@interface FUISwitch()
@property(strong, readwrite, nonatomic) UIView *thumbView;
@property(strong, readwrite, nonatomic) UIScrollView *internalContainer;
@end
...
- (void) layoutSubviews {
    ...
    //labels
    CGRect left = CGRectMake(0, 3, (self.internalContainer.contentSize.width - self.thumbView.frame.size.width)/2, contentHeight);
    CGRect right = left;
