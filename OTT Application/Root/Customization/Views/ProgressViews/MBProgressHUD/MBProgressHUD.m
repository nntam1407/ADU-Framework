...
- (void)layoutSubviews {
	...
	CGSize labelSize = [Utils constrainedBoundsForText:label.text
                                                  font:label.font
	...
	CGSize detailsLabelSize = [Utils constrainedBoundsForText:label.text
                                                         font:detailsLabel.font
                                                lineBreakMode:detailsLabel.lineBreakMode
                                                textAlignment:detailsLabel.textAlignment
                                                    limitSize:maxSize];
