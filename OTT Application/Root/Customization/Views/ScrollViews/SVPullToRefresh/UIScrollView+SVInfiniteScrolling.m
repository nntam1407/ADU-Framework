...
- (void)scrollViewDidScroll:(CGPoint)contentOffset {
    if(self.state != SVInfiniteScrollingStateLoading && self.enabled) {
        ...
        // TamNN: insert contentOffset.y >= 0
        else if(contentOffset.y > scrollOffsetThreshold && contentOffset.y >= 0 && self.state == SVInfiniteScrollingStateStopped && self.scrollView.isDragging)
