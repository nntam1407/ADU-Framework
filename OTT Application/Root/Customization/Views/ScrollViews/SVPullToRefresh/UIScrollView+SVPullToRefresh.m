...
/* Nexle TamNN's codes */
- (void)setTableViewHeaderHeight:(float)tableViewHeaderHeight {
    /* Nexle TamNN's codes */
    CGRect pullToRefreshViewFrame = self.pullToRefreshView.frame;
    
    if(tableViewHeaderHeight > 0) {
        pullToRefreshViewFrame.origin.y += tableViewHeaderHeight;
        self.pullToRefreshView.frame = pullToRefreshViewFrame;
        self.pullToRefreshView.firstStartOriginY = tableViewHeaderHeight;
    }
}
...
- (id)initWithFrame:(CGRect)frame {
    if(self = [super initWithFrame:frame]) {
        ...
        self.titles = [NSMutableArray arrayWithObjects:NSLocalizedString(@"Pull to refresh...", @"NSString"),
                       NSLocalizedString(@"Release to refresh...", @"NSString"),
                       NSLocalizedString(@"Loading...", @"NSString"),
                       nil];
...
- (void)scrollViewDidScroll:(CGPoint)contentOffset {
    if(self.state != SVPullToRefreshStateLoading) {
        CGFloat scrollOffsetThreshold = (self.frame.origin.y - self.firstStartOriginY)-self.originalTopInset;
...
- (UILabel *)titleLabel {
    if(!_titleLabel) {
        ...
        _titleLabel.text = NSLocalizedString(@"Pull to refresh...", @"UILabel");
...
- (void)setLastUpdatedDate:(NSDate *)newLastUpdatedDate {
    ...
    self.dateLabel.text = [NSString stringWithFormat:NSLocalizedString(@"Last Updated: %@", @"UILabel"), newLastUpdatedDate?[self.dateFormatter stringFromDate:newLastUpdatedDate]:NSLocalizedString(@"Never", @"NSString")];
}

- (void)setDateFormatter:(NSDateFormatter *)newDateFormatter {
	dateFormatter = newDateFormatter;
    self.dateLabel.text = [NSString stringWithFormat:NSLocalizedString(@"Last Updated: %@", @"NSString"), self.lastUpdatedDate?[newDateFormatter stringFromDate:self.lastUpdatedDate]:NSLocalizedString(@"Never", @"NSString")];
}
